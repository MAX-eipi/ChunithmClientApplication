define(["require", "exports", "../src/MusicData", "../src/MusicDataTable"], function (require, exports, MusicData_1, MusicDataTable_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function createTestMusicDataTable(musicDatas) {
        return MusicDataTable_1.MusicDataTable.createByParameters(musicDatas);
    }
    function createMusicData(id, name, genre, basicLevel, advancedLevel, expertLevel, masterLevel, basicVerified, advancedVerified, expertVerified, masterVerified) {
        var musicData = new MusicData_1.MusicData();
        musicData.Id = id;
        musicData.Name = name;
    ...
    describe("MusicDataTable", () => {
        ...
        it("Read JSON", () => {
            ...
            var jsonDataTable = MusicDataTable_1.MusicDataTable.createByJson(json);
    ...
    describe("MusicDataTable", () => {
        ...
        it("Update", () => {
            var actualDataTable = MusicDataTable_1.MusicDataTable.mergeMusicDataTable(oldDataTable, newDataTable);
